...
-- Comment
keymap("n", "<leader>gc", "<cmd>lua require('Comment.api').toggle_current_linewise()<CR>", opts)
keymap("v", "<leader>gc", '<ESC><CMD>lua require("Comment.api").toggle_linewise_op(vim.fn.visualmode())<CR>')
...
keymap("n", "<leader>vp", ":vsplit<CR>", opts)
